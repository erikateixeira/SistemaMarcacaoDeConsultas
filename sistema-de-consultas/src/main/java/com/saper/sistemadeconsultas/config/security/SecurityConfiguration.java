...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests( (authz)->authz
                ...
                .requestMatchers(HttpMethod.GET, "/consulta/ligacao").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                .requestMatchers(HttpMethod.GET, "/consulta/ps").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                .requestMatchers(HttpMethod.GET, "/consulta/pag").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                ...
                .requestMatchers(HttpMethod.GET, "/consulta/iniciar").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                .requestMatchers(HttpMethod.GET, "/consulta/medicos-disponiveis").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                .requestMatchers(HttpMethod.GET, "/consulta/datas-disponiveis").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                .requestMatchers(HttpMethod.GET, "/consulta/horas-validas").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                ...
                .requestMatchers(HttpMethod.PUT, "/consulta").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
